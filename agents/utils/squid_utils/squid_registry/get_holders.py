...
class HolderType(str, Enum):
    """
    Enumeration of available types of stock ownership and sustainability data.
    """
    # Available types of stock ownership and sustainability data
...
class HoldersInput(BaseModel):
    """
    Pydantic model for validating input parameters for holders' information retrieval.
    
    Args:
        ticker (str): The ticker symbol of the stock
        holder_type (HolderType): The type of holders' information to fetch
    """
...
def get_holders_info(ticker: str, holder_type: HolderType):
    ...
    # Return error if invalid holder type is provided
